  ...
  const roles = [
    {
      ...
      title: "Citizen",
      description:
        "Report cleanliness issues and track sustainability efforts",
      icon: Users,
      path: "/citizen",
    ...
    },
    {
      ...
      title: "Post Office",
      description:
        "Zone Manager – Monitor and manage local cleanliness zones",
      icon: Building2,
      path: "/post-office",
    ...
    },
    {
      ...
      description:
        "Supervisor – Oversee multiple zones and performance analytics",
      icon: MapPin,
      path: "/divisional",
    ...
    },
    {
      ...
      title: "Workers",
      description:
        "Worker task assignment, live tracking & performance monitoring",
      icon: Users,
      path: "#",
  ...
  return (
    <div className="min-h-screen relative overflow-hidden font-sans">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50">
        ...
        <div
          className="absolute bottom-0 right-0 w-96 h-96 bg-teal-100 rounded-full blur-3xl opacity-50 animate-pulse"
          ...
          <div className="mb-16 space-y-6">
            ...
            <div>
              <div className="flex items-center justify-center gap-2 mb-4">
                ...
                <Sparkles
                  className="h-6 w-6 text-teal-500 animate-pulse"
            ...
            {roles.map((role) => {
              ...
              return (
                <div
                  key={role.id}
                  onClick={() =>
                    !role.disabled && navigate(role.path)
                  }
                  className={`group relative overflow-hidden rounded-3xl bg-white/80 border-2
                    ${
                      role.disabled
                        ? "border-dashed border-gray-300 cursor-not-allowed opacity-70"
                        : "border-transparent hover:border-emerald-300 hover:shadow-xl cursor-pointer"
                    }
                    transition-all duration-500 ${role.delay}`}
                >
                  {/* Gradient Overlay */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${role.gradient}
                    opacity-0 ${
                      !role.disabled && "group-hover:opacity-10"
                  ...
                  <div className="relative p-8 space-y-6">
                    ...
                    <div className="flex justify-between items-start">
                      <div
                        className={`h-20 w-20 rounded-2xl bg-gradient-to-br ${role.gradient}
                      ...
                      className={`w-full py-3 font-semibold rounded-xl shadow-md transition-all
                        ${
                          role.disabled
                            ...
                            : "bg-gradient-to-r from-emerald-500 via-green-500 to-teal-500 text-white hover:shadow-lg hover:scale-[1.02]"
                        }`}
                    >
                      {role.disabled ? "Launching Soon" : "Access Dashboard"}
                    </button>
                  </div>
                </div>
              );
